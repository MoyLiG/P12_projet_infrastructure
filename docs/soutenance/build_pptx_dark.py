...
sections = [
    ...
    ("03", "Pipeline & qualité", "sept étapes, trois lignes de défense"),
...
abox(0.6, 4.75, 3.0, 0.85, "Générateur", "3948 activités / 12 mois", bar=VIOLET)
arrow(3.75, 3.9)
...
# =====================================================================
divider("03", "Pipeline & qualité", "Sept étapes, et trois lignes de défense sur la donnée.")
...
positions = [(0.6 + i * 3.05, 2.6) for i in range(4)] + [(0.6 + i * 3.05, 4.55) for i in range(3)]
...
textbox(s, 0.95, 4.35, 5, 0.5, [[R("11 / 11 tâches  ·  ~20 s", 14, TXT, False, F_MONO)]])
